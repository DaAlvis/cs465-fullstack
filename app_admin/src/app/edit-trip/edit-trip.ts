...
export class EditTrip implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.tripData.getTrip(tripCode).subscribe({
      next: (value: any) => {
        this.trip = value;
        // Populate form — remove [0] if your service returns an object
        this.editForm.patchValue(Array.isArray(value) ? value[0] : value);
  ...
  // getter for easy access in template: f['name']
